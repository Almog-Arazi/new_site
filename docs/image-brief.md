...
> **סטטוס: 27 התמונות יוצרו ומוטמעות באתר** (`public/uploads/`, WebP 1600px).
> המסמך נשאר כמקור האמת — הן לרשימת הצילומים ביום צילום אמיתי, והן לייצור
> מחדש של תמונה בודדת. סדר העדיפות להחלפה בצילום אמיתי מופיע ב-`launch-checklist.md`.
